...
3. **Add Environment Variables** (in Render → Environment tab)
   ...
   | `RECIPIENT_EMAILS` | n.tessier@immiami.com,h.baykam@immiami.com,m.allenjohnson@immiami.com,nathalie@tessier.biz,i.belmonte@immiami.com,a.berkowitz.tutor@immiami.org,j.sanz@immiami.com,a.wood@immiami.com,r.hosn@immiami.com,s.fortezza@immiami.com,v.villalobos@immiami.com|
